...
const BASE = 18
const LEADING = 212  // 240ths of a line — Word's own "single" leaves the page airier than the PDF
...
const bullets = (items) =>
  items.map((item) =>
    new Paragraph({ bullet: { level: 0 }, indent: { left: 200, hanging: 150 }, spacing: { after: 20 }, children: [text(item)] }),
  )
